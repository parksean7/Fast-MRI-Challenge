...
from utils.learning.train_part_classifier_cnn import train
from utils.common.utils import seed_fix


def parse():
    parser = argparse.ArgumentParser(description='Train anatomyClassifier on FastMRI challenge Images',
    ...
    parser.add_argument('-n', '--net-name', type=Path, default='anatomy_router', help='Name of network')
    ...
    parser.add_argument('--optim-type', type=str, choices=['Adam', 'AdamW'], default='Adam', help='Optimizer Tpe')
